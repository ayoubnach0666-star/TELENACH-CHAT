...
export const BottomNav: React.FC<BottomNavProps> = ({ currentScreen, onNavigate, onPlusClick }) => {
  return (
    <div className="h-20 bg-black/40 backdrop-blur-xl border-t border-white/5 flex items-center justify-around px-8 relative">
      <button 
      ...
      <button 
        onClick={onPlusClick}
        className="relative -top-6 w-14 h-14 bg-orange-600 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-orange-600/30 active:scale-95 transition-all"
      >
